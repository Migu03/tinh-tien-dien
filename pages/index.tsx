...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Web Tính Tiền Điện Gia Đình 11C</title>
      ...
      <main className={styles.main}>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <table className="table table-striped mt-5">
            <thead>
              <tr>
                <th scope="col">Số Tiền Điện Ngoài Phòng</th>
                <th scope="col">Số Tiền Điện Tầng 3</th>
                <th scope="col">Số Tiền Điện Tầng 4</th>
              </tr>
            </thead>
            <tbody>
              <tr>
